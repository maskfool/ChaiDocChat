...
import { FileText, Upload, MessageCircle, TrendingUp, Shield, Star, Eye, EyeOff, Mail, Lock, Bot } from "lucide-react"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight text-white">
                    Chat with Your <span className="text-[#f97315] animate-pulse">Documents</span> Instantly
                  </h2>

                  <p className="text-lg lg:text-xl text-gray-400 leading-relaxed max-w-lg">
                    Upload PDFs, Word documents, or share URLs and start intelligent conversations with your content.
                  </p>
                </div>
              </div>
                ...
                <div className="relative z-10">
                  <div className="text-center space-y-4 pb-6 pt-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-gray-400 text-sm">Sign in to start chatting with your documents</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 px-6 pb-6">
                    ...
                    <div className="text-center pt-2 space-y-2">
                      <button className="text-gray-400 hover:text-[#f97315] p-0 text-sm transition-colors block">
